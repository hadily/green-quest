 ...
 */
final class Version20240816185349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD image_filename VARCHAR(255) NOT NULL, CHANGE writer_id writer_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_23A0E661BC7E6B6');
        $this->addSql('ALTER TABLE article DROP image_filename, CHANGE writer_id writer_id INT NOT NULL');
